...
拦截邮件链接，避免误触时直接打开系统邮件应用。Mailto Capture 会先在网页内显示简洁的内容预览，列出收件人、抄送与密送地址、主题、正文及链接附带的其他信息，供您按需复制。此外，也支持 `tel:` 与 `sms:` 外部协议跳转链接，并按照识别到的编号计划格式化国际电话号码及显示相应国家或地区。中国座机号码还会显示区号归属地，手机号码暂时只识别到国家层级；墨西哥号码会显示首位号码对应的大区。
