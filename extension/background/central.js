...
export const PROVINCE_PRODUCTS = Object.freeze({
  ...
  operations: Object.freeze([
    FEATURE_IDS.ANY_COPY, FEATURE_IDS.ANY_COPY_ENHANCED, FEATURE_IDS.REDUCE_WHITE_POINT, FEATURE_IDS.XHS_IMAGE_DARK_MODE, 'satellites', 'administration'
  ]),
...
const PAGE_PRODUCTS = Object.freeze([
  ...
  FEATURE_IDS.REDUCE_WHITE_POINT, FEATURE_IDS.XHS_IMAGE_DARK_MODE
]);
...
function productForMessage(message) {
  ...
  if (message.type === 'UI_SET_REDUCE_WHITE_POINT_SETTING') return FEATURE_IDS.REDUCE_WHITE_POINT;
