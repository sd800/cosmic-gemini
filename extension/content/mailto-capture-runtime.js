    ...
    render() {
      ...
      style.textContent = `
        ...
        *{box-sizing:border-box;letter-spacing:normal}
        ...
        .heading{display:flex;align-items:center;justify-content:space-between;gap:8px;margin:0 0 7px}.heading strong{font-size:15px;line-height:1.2;font-weight:700}.close{display:grid;width:24px;height:24px;place-items:center;border:0;border-radius:50%;background:transparent;color:var(--mc-muted);cursor:pointer}.close:hover{background:var(--mc-raised)}
