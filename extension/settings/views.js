    ...
    primary: `
      ...
      <section class="card satellite-card access-control-card" data-feature-id="accessControl" data-list-section="blockedDomains" data-empty-key="accessControlEmptyDomains">
        ...
        <fieldset id="accessControlOptions" class="access-control-options" disabled>
          ...
          <p class="form-message" aria-live="polite"></p>
          <ul class="rule-list"></ul>
          <p class="rule-list-note" hidden></p>
        ...
        <fieldset id="documentPreviewOptions" class="knowledge-options document-preview-options" disabled>
          ...
          <div class="knowledge-row">
            ...
            <select id="documentPdfSampling" aria-labelledby="documentPdfSamplingLabel" aria-describedby="documentPdfSamplingHelp">
              ...
              <option value="4" selected data-i18n="documentPdfSamplingDefault">4× (default)</option>
      ...
      <section class="card satellite-card website-fixer-card">
        ...
        <fieldset id="websiteFixerOptions" class="knowledge-options website-fixer-options" disabled>
          <section class="website-fixer-item">
            <div class="website-fixer-heading"><span class="website-fixer-icon" data-section-icon="translateOverride" aria-hidden="true"></span><h3 id="websiteFixerTranslateTitle" data-i18n="websiteFixerTranslateName"></h3><label class="switch"><input id="websiteFixerTranslateOverrideEnabled" type="checkbox" aria-labelledby="websiteFixerTranslateTitle"><span></span></label></div>
          ...
          <section class="website-fixer-item">
            <div class="website-fixer-heading"><span class="website-fixer-icon" data-section-icon="stayOnPage" aria-hidden="true"></span><h3 id="websiteFixerStayTitle" data-i18n="websiteFixerStayName"></h3><label class="switch"><input id="websiteFixerStayOnPageEnabled" type="checkbox" aria-labelledby="websiteFixerStayTitle"><span></span></label></div>
