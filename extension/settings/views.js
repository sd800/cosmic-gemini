...
export function viewFor(featureId) {
  ...
  if (featureId === 'satellites') return {
    primary: `
      ...
      <section class="card satellite-card reduce-white-point-card">
        <div class="section-heading">
          <div><h1 data-i18n="reduceWhitePointName"></h1><p data-i18n="reduceWhitePointDescription"></p></div>
          <div class="satellite-control"><label class="switch"><input id="reduceWhitePointEnabled" type="checkbox"><span></span><b class="sr-only">Reduce White Point</b></label></div>
        </div>
        ...
        <div class="satellite-privacy"><strong data-i18n="biliDailyLoginPrivacyHeading"></strong><p data-i18n="reduceWhitePointPrivacy"></p></div>
      </section>
