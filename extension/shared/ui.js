export function icon(name) {
  const paths = {
    ...
    xhsImageDarkReader: '<path d="M8.7 15.5A6.4 6.4 0 1 1 15.3 15.5C14.5 16.1 14 17 14 18H10c0-1-.5-1.9-1.3-2.5Z"/><path d="M10 21h4M9.5 18h5"/>',
    xhsImageDarkReaderActive: '<path d="M8.7 15.5A6.4 6.4 0 1 1 15.3 15.5C14.5 16.1 14 17 14 18H10c0-1-.5-1.9-1.3-2.5Z" fill="currentColor" stroke="none"/><path d="M10 21h4M9.5 18h5"/>',
