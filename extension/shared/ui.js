export function icon(name) {
  const paths = {
    ...
    xhsImageDarkMode: '<path d="M2.5 4.2c3.6-.8 6.7.2 9.5 2.5 2.8-2.3 5.9-3.3 9.5-2.5v7.4c-2.4-.5-4.5-.3-6.4.5M8.9 12.1c-1.9-.8-4-.9-6.4-.5M12 6.7v2.1"/><path d="M8.6 15a4.45 4.45 0 1 1 6.8 0c-.9.75-1.4 1.65-1.4 2.75h-4c0-1.1-.5-2-1.4-2.75Z"/><path d="M9.7 18.3h4.6M10.2 21h3.6"/>',
    xhsImageDarkModeActive: '<path d="M2.5 4.2c3.6-.8 6.7.2 9.5 2.5 2.8-2.3 5.9-3.3 9.5-2.5v7.4c-2.4-.5-4.5-.3-6.4.5M8.9 12.1c-1.9-.8-4-.9-6.4-.5M12 6.7v2.1"/><path d="M8.6 15a4.45 4.45 0 1 1 6.8 0c-.9.75-1.4 1.65-1.4 2.75h-4c0-1.1-.5-2-1.4-2.75Z" fill="currentColor" stroke="none"/><path d="M9.7 18.3h4.6M10.2 21h3.6"/>',
