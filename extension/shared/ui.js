export function icon(name) {
  const paths = {
    ...
    xhsImageDarkMode: '<path d="M2.7 10.6c2.7-.6 5.2-.1 7.4 1.2M2.7 10.6v8.1c2.9-.6 5.6-.1 8.1 1.6M21.3 10.6c-2.7-.6-5.2-.1-7.4 1.2M21.3 10.6v8.1c-2.9-.6-5.6-.1-8.1 1.6M12 16v4.3"/><path d="M8.7 9.8A4.25 4.25 0 1 1 15.3 9.8c-.8.65-1.3 1.45-1.3 2.45h-4c0-1-.5-1.8-1.3-2.45Z"/><path d="M10 14.9h4M10.5 12.3h3"/>',
    xhsImageDarkModeActive: '<path d="M2.7 10.6c2.7-.6 5.2-.1 7.4 1.2M2.7 10.6v8.1c2.9-.6 5.6-.1 8.1 1.6M21.3 10.6c-2.7-.6-5.2-.1-7.4 1.2M21.3 10.6v8.1c-2.9-.6-5.6-.1-8.1 1.6M12 16v4.3"/><path d="M8.7 9.8A4.25 4.25 0 1 1 15.3 9.8c-.8.65-1.3 1.45-1.3 2.45h-4c0-1-.5-1.8-1.3-2.45Z" fill="currentColor" stroke="none"/><path d="M10 14.9h4M10.5 12.3h3"/>',
