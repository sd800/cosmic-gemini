...
- Included: the complete ICANN section; the GitHub, GitLab, Cloudflare, CentralNic, Coordination Center for TLD RU, and EU.org PRIVATE groups; and PSL PRIVATE DOMAINS-sector geographic eTLD rules
